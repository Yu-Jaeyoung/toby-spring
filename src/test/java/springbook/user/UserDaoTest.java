...
public class UserDaoTest {
    ...
    @BeforeEach
    void setUp() {
        this.user1 = new User("B", "비", "password", Level.BASIC, 1, 0);
        this.user2 = new User("C", "씨", "password", Level.SILVER, 55, 10);
        this.user3 = new User("A", "에이", "password", Level.GOLD, 100, 40);
    }
